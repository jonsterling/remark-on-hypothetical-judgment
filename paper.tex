...
\begin{align*}
  ...
  \VAL{\Imp{P}{Q}} &\equiv 
    \{ \Lam{x}{E}
    \mid \GenJ{x}{\HypJ{\Member{E}{\EXP{Q}}}{\Member{x}{\EXP{P}}}}
    \}\\
  \VAL{\Conj{P}{Q}} &\equiv
    \{ \Pair{M}{N}
    \mid \Member{M}{\EXP{P}}, \Member{N}{\EXP{Q}}
    \}\\
  \EXP{P} &\equiv
    \{ M
    \mid \Eval{M}{M'}, \Member{M'}{\VAL{P}}
    \}
\end{align*}

Then, the judgments of the logical theory are explained by appealing to the
logical relations:
...
The judgments of a basic theory of sets may also be explained using the logical
relations:
\begin{gather*}
  \infer={
    \IsSet{A}
...
\begin{gather}
  \Member{\Lam{x}{\Pair{\It}{\It}}}{\EXP{\Imp{\False}{\True}}}\\
  \Eval{\Lam{x}{\Pair{\It}{\It}}}{\Lam{x}{\Pair{\It}{\It}}}, \quad
    \Member{\Lam{x}{\Pair{\It}{\It}}}{\VAL{\Imp{\False}{\True}}}\\
  \GenJ{x}{
    \HypJ{\Member{\Pair{\It}{\It}}{\EXP{\True}}}{\Member{x}{\EXP{\False}}}
  }\\
  \GenJ{x}{
    \HypJ{\Member{\Pair{\It}{\It}}{\EXP{\True}}}{\Eval{x}{M}, \Member{M}{\VAL{\False}}}
  }
\end{gather}
...
explanation and also add ``use'' rules (i.e. direct elimination) for each
proposition in addition to the verification rules.

%%% TODO:
%%% - (nuprl) type theory as binary logical relations
%%% - what do the propositions give us over the judgments? (witnesses, extensional identity)
%%% - harper's presentation of admissibility & derivability in pfpl
%%% - noam zeilberger's use of non-uniform hypothetical judgment
